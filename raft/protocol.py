...
class BaseMessage(object):
    ...
    def __str__(self):
        return f"BaseMessage[{self._timestamp}: type={self._type} term={self._term} sender={self._sender} receiver={self._receiver} dir={self._direction} res={self._results}]"
